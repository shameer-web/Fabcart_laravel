              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label> Small Descriptions</label>
                                <textarea row="4" id="summernote" name="small_description" class="form-control" placeholder="Enter the Descriptions"></textarea>             
                </div>
                ...
                <div class="row mt-3">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="p_highlight_heading" placeholder="High Lights Heading" class="form-control">
                      <textarea name="p_highlights" id="summernote1" placeholder="Product High Lights " rows="4" class="form-control"></textarea>
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="p_description_heading" placeholder="Product Descriptions Heading" class="form-control">
                      <textarea name="p_description" id="summernote2" placeholder="Product Descriptions " rows="4" class="form-control"></textarea>
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="p_details_heading" placeholder="Product Details/Specifications Heading" class="form-control">
                      <textarea name="p_details" id="summernote3" placeholder="Product Details/Specifications" rows="4" class="form-control"></textarea>
                 ...
                 <div class="row mt-3">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="meta_title" id="summernote4" placeholder="Meta Title " rows="4" class="form-control"></textarea>
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="meta_description" id="summernote5" placeholder="Meta Descriptions " rows="4" class="form-control"></textarea>
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="meta_keywords" id="summernote6" placeholder="Meta Keywords " rows="4" class="form-control"></textarea>
                 ...
                 <div class="row mt-3">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                     ...
                     <input type="checkbox" name="featur_products" class="form-control">
