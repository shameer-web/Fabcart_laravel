		...
		<div class="col-md-12 mb-3">
            <div class="product_data">
			  ...
			  <div class="row">
				<div class="col-md-5">
					<div class="border">
						<img src="{{ asset('uploads/products/'.$products->product_image) }}" alt="" class="w-100">
				...
				<div class="col-md-7">
					...
					<div class="product-heading py-2 border-top">
						 <h5 class="font-weight-bold mb-0">{{ $products->name }}</h5>
					</div>
					<div class="py-2">
						<small>Rating:
                               @for($i=1 ;$i<=5 ;$i++)
					...
					<div class="py-3">
						<div class="row">
							<div class="col-md-2 col-3">
								<input type="hidden"  class="product_id" value="{{ $products->id }}" name="">
								<input type="number" class="qty-input form-control" value="1" min="1" max="100" name="">
				...
				<div class="col-md-12">
					...
					<div class="product-highlight py-2 borde-top">
						<div class="card">
							<div class="card-header">
								<h6 class="highlight-heading mb-0 font-weight-bold">
					...
					<div class="product-description py-2 border-top">
						<div class="card">
						  <div class="card-header">
							 <h6 class="prod-desc-heading mb-0 font-weight-bold">
